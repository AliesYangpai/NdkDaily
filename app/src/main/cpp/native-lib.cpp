...
Java_com_alie_ndkdaily_NativeLoad_dailyWork28(JNIEnv *env, jobject thiz, jbyteArray dst,
                                              jbyteArray src, jdouble threshold1,
                                              jdouble threshold2) {
    // 1.src to matSrc
...
extern "C"
JNIEXPORT void JNICALL
Java_com_alie_ndkdaily_NativeLoad_dailyWork29(JNIEnv *env, jobject thiz, jbyteArray dst,
                                              jbyteArray src, jdouble threshold1,
                                              jdouble threshold2) {
    // src to  matSrc
    // matSrc to  matCanny
...
extern "C"
JNIEXPORT void JNICALL
Java_com_alie_ndkdaily_NativeLoad_dailyWork31(JNIEnv *env, jobject thiz, jbyteArray dst,
                                              jbyteArray src, jdouble threshold1,
                                              jdouble threshold2) {
    // src to matSrc
    // matSrc to matCanny
...
extern "C"
JNIEXPORT void JNICALL
Java_com_alie_ndkdaily_NativeLoad_dailyWork32(JNIEnv *env, jobject thiz, jbyteArray dst,
                                              jbyteArray src, jint d, jdouble sigma_color,
                                              jdouble sigma_space) {
    // src to matSrc
    // matSrc to matBilateral
